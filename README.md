...
A retrieval-augmented chatbot tailored for Yantra Live brochures. The agent answers **only** from the curated knowledge base and returns brochure images whenever they support a reply.
